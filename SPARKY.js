...
let Sparkyaudio = JSON.parse(fs.readFileSync('./src/audio.json'));
...
switch(command) {
    ...
    let { data } = await axios.get('https://api.github.com/repos/Sparkymon777/SPARKY-BOT');
    teks = `*SPARKY Script*\n\n*Total Stars*: ${data.stargazers_count}⭐\n*Total Forks*: ${data.forks_count} forks\n*GitHub*: https://github.com/Sparkymon777/SPARKY-BOT\n\nDont forget to follow me on *GitHub* and give a ⭐️ to my projects. `
    let buttons = [
...
case 'support': case 'supportgc':
    ...
    reply(`*My developer's group:* https://bit.ly/SPARKYSUPPORTGROUP`)
    break

case 'repo': case 'botrepo':
    
    reply(`My Source Code is - https://github.com/Sparkymon777/SPARKY-BOT`)
    break
